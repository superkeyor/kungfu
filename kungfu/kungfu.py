...
Frame.cols = Frame.Columns
# Frame.columns is a built-in object property
Frame.cnames = Frame.Columns
Frame.names = Frame.Columns
Frame.rows = Frame.Indices
Frame.rnames = Frame.Indices
Frame.indices = Frame.Indices
...
Frame.itercols = Frame.iteritems
